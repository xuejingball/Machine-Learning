...
class ExpectationMaximizationTestCluster():
    ...
    def run(self):
        ...
        for k in self.clusters:
            ...
            if k == self.targetcluster and self.stats:
                ...
                pd_data.to_csv("adult_cluster_em.csv", index=False, index_label=False, header=False)
    ...
    def plot(self, ll, homogeneity, completeness, rand, bic, aic):
            ...
            plt.title('Adult-EM-Log Probability')
            #plt.show()
            ...
            plt.title('Adult-EM-Homogeneity Score')
            #plt.show()
            ...
            plt.title('Adult-EM-Completeness Score')
            #plt.show()
