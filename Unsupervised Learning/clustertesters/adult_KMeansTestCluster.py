...
class KMeansTestCluster():
    ...
    def run(self):
        ...
        for k in self.clusters:
            ...
            if k == self.targetcluster and self.stats:
                ...
                pd_data.to_csv("adult_cluster_kmeans.csv", index=False, index_label=False, header=False)
                #print model.cluster_centers_
                print (cdist(self.X, model.cluster_centers_, 'euclidean').shape)
    ...
    def plot(self, meandist, homogeneity, completeness, rand, silhouettes):
            ...
            plt.title('Adult-Kmeans-Average within cluster SSE')
            #plt.show()
            ...
            plt.title('Adult-Kmeans-Homogeneity Score')
           # plt.show()
            ...
            plt.title('Adult-Kmeans-Completeness Score')
            plt.show()
