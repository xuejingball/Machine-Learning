...
dataBoost = read.csv("BoostedJ48-learning curve.csv")
...
ggplot(dfSMO, aes(x=percentage, y=error, colour=mode)) + 
  geom_line() + geom_point() + 
  scale_color_manual(labels = c("GaussianCV","PolynomialCV", "GaussianTrain", "PolynomialTrain"), 
...
dataSMOP = read.csv("SMO_PolyKernel-learning curve.csv")
